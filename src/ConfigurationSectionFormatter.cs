...
namespace Microsoft.Extensions.Configuration
{
    ...
    public class ConfigurationSectionFormatter : IConfigurationSection
    {
        ...
        {
            return _section.GetChildren().Select(s => s.ApplyConfigurationFormatter(Root, ConfigurationFormatter, SectionList, KeyValues));
        }
        ...
        {
            return _section.GetSection(key).ApplyConfigurationFormatter(Root, ConfigurationFormatter, SectionList, KeyValues);
        }
