...
namespace DotNetCore.Configuration.Formatter.Test
{
    public class FormatStringUnitTest
    {
        ...
        [InlineData("head_{Key}{Key4}_tail", "head_?Key?Value4_tail")]
        [InlineData("head_{Key}{Key4}", "head_?Key?Value4")]
        [InlineData("{Key}{Key4}_tail", "?Key?Value4_tail")]
        [InlineData("{Key}{Key4}", "?Key?Value4")]
        [InlineData("{Key}-{Key4}", "?Key?-Value4")]
